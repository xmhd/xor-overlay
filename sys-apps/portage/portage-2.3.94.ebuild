...
python_prepare_all() {
	...
	if use build || ! use rsync-verify; then
        ...
        einfo "Updating GENTOO_MIRRORS..."
        sed -e 's|^GENTOO_MIRRORS=.*$|GENTOO_MIRRORS="https://fastpull-us.funtoo.org http://distfiles.gentoo.org"|' -i cnf/make.globals || die "sed failed"
