...
IUSE="binary btrfs clang custom-cflags debug dmraid ec2 firmware iscsi luks lvm mcelog mdadm microcode multipath nbd nfs plymouth selinux sign-modules symlink systemd wireguard zfs"
...
# minimal patch set to compliment Kernel-Self-Protection-Project
HARDENED_PATCHES=(
	...
	0112-Linux-hardened-5.11.8-hardened1.patch
)
...
src_prepare() {
	...
	if ! use clang; then
		...
		# currently investigating some issues with this
