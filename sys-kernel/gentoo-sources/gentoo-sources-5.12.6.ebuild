...
#	0033-enable-protected_-symlinks-hardlinks-by-default.patch
	...
	0108-dccp-ccid-move-timers-to-struct-dccp_sock.patch
	0109-Revert-dccp-don-t-free-ccid2_hc_tx_sock-struct-in-dc.patch
	0110-ovl-add-config-to-disable-unprivileged-user-namespac.patch
)
