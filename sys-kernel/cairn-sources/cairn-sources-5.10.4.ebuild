...
KERNEL_CONFIG_UPSTREAM="https://salsa.debian.org/kernel-team/linux/-/raw/debian/5.10.2-1_exp1/debian/config"
...
HARDENED_PATCHES=(
    ...
    0087-sysctl-expose-proc_dointvec_minmax_sysadmin-as-API-f.patch
    0088-usb-add-toggle-for-disabling-newly-added-USB-devices.patch
    0089-usb-implement-dedicated-subsystem-sysctl-tables.patch
    0090-hard-wire-legacy-checkreqprot-option-to-0.patch
    0091-security-tty-Add-owner-user-namespace-to-tty_struct.patch
    0092-security-tty-make-TIOCSTI-ioctl-require-CAP_SYS_ADMI.patch
    0093-enable-SECURITY_TIOCSTI_RESTRICT-by-default.patch
    0094-disable-unprivileged-eBPF-access-by-default.patch
    0095-enable-BPF-JIT-hardening-by-default-if-available.patch
    0096-enable-protected_-fifos-regular-by-default.patch
    0097-Revert-mark-kernel_set_to_readonly-as-__ro_after_ini.patch
    0098-modpost-Add-CONFIG_DEBUG_WRITABLE_FUNCTION_POINTERS_.patch
    0099-mm-Fix-extra_latent_entropy.patch
    0100-add-CONFIG-for-unprivileged_userns_clone.patch
    0101-enable-INIT_ON_ALLOC_DEFAULT_ON-by-default.patch
    0102-enable-INIT_ON_FREE_DEFAULT_ON-by-default.patch
    0103-add-CONFIG-for-unprivileged_userfaultfd.patch
    0104-slub-Extend-init_on_alloc-to-slab-caches-with-constr.patch
    0105-net-tcp-add-option-to-disable-TCP-simultaneous-conne.patch
    0106-kconfig-select-DEBUG_FS_ALLOW_NONE-by-default-if-DEB.patch
    0107-stop-hiding-SYSFS_SYSCALL-behind-EXPERT.patch
    0108-disable-SYSFS_SYSCALL-by-default.patch
    0109-stop-hiding-UID16-behind-EXPERT.patch
    0110-disable-UID16-by-default.patch
