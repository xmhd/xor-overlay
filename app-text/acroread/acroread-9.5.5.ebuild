...
inherit eutils gnome2-utils multilib-build nsplugins
...
KEYWORDS="x86 amd64"
SLOT="0"
IUSE="cups html ldap libressl nsplugin"
...
RDEPEND="
	...
	app-accessibility/at-spi-atk[${MULTILIB_USEDEP}]
	...
	media-libs/libcanberra[${MULTILIB_USEDEP}]
	...
	ldap? ( >=net-dns/openldap-2.4.38-r1[${MULTILIB_USEDEP}] )
	x11-libs/pango[X, ${MUTLILIB_USEDEP}]
